...
const jobs = [
  ...
  function searchJobs(jobTitle, location) {
    const searchTitle = jobTitle.toLowerCase()
    ...
    for (const job of jobs) {
        ...
        if (jobTitleLower.includes(searchTitle) && jobLocationLower.includes(searchLocation)) {
            results.push(job)
        }
    }
...
document.getElementById("searchButton").addEventListener("click", () => {
    ...
    const searchResult = searchJobs(jobTitle, location)
